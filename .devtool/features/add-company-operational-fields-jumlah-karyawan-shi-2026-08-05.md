...
## Acceptance Criteria
- [ ] `JumlahKaryawan`, `JumlahShift`, `JamKerjaPerHari`, `HariKerjaPerMinggu` fields added to `Subscription` (or a `CompanyProfile` child entity, if that pattern is adopted for other cards in this epic set)
