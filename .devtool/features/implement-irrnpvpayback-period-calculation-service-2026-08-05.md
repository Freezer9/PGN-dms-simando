...
## Acceptance Criteria
- [ ] Clarify cash-flow model/assumptions with business stakeholders before implementation
- [ ] `IFeasibilityService` (or similar) computing IRR, NPV, and Payback Period from capex + pricing + expected usage data
- [ ] Unit tests covering the calculation logic with known reference values
