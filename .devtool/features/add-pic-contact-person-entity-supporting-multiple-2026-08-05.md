...
## Acceptance Criteria
- [ ] `PicContact` entity added (Nama, Jabatan, Email, NoHp, Linkedin, Instagram, Facebook, SubscriptionId FK)
- [ ] Supports 1-N contacts per subscription (spec shows 2, but don't hardcode a max of 2 in the schema)
