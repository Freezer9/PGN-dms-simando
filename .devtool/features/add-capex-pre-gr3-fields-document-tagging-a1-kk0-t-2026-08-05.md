...
## Acceptance Criteria
- [ ] `BiayaPenyambunganReguler`, `BiayaPenyambunganExtra`, `Jumlah` (computed) fields added to `NolApplication`
- [ ] Upload flow requires/allows tagging the Capex Pre-GR3 upload against A1 and/or KK0 source documents
- [ ] Depends on `epic-documents` structured upload work
