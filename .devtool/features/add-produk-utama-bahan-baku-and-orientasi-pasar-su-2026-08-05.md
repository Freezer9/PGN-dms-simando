...
## Acceptance Criteria
- [ ] `ProdukUtama` entity (Nama, KapasitasPerTahun, SubscriptionId)
- [ ] `BahanBaku` entity (Nama, ImporOrLokal, Negara, VolumePerBulan, SubscriptionId)
- [ ] `OrientasiPasar` entity (Nama, ImporOrLokal, Negara, VolumePerBulan, SubscriptionId)
