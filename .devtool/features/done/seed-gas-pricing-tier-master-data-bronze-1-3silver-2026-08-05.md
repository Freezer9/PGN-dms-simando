...
## Acceptance Criteria
- [x] `PricingTier` entity/table (TierName, SegmentCode, Period [Harian/Bulanan/Tahunan], RateUsd)
- [x] Seeded with the rates shown in the spec (confirm current rates with business before going live — spec values may be stale examples)
