...
## Acceptance Criteria
- [x] `NolApplication` entity added, FK to `Subscription` (1:1 or 1:N if re-applications are allowed)
- [x] "Sama dengan A1" flag that copies from the A1-stage usage data vs. manual override entry
