...
## Acceptance Criteria
- [x] Repeatable contact block (add/remove) rendering Nama/Jabatan/Email/No HP/LinkedIn/IG/FB fields
- [x] Client-side validation for email format and required Nama/Jabatan (marked `*` in spec)
- [x] Wired to the new PIC CRUD endpoints via a typed service (following the `ISubscriptionService` pattern)
