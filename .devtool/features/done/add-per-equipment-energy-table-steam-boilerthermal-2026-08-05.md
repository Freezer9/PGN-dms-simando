...
## Acceptance Criteria
- [x] `EnergyEquipment` entity (EquipmentName, CapacityPerUnit, CapacityUnit, JamPerHari, HariPerMinggu, FuelSource, MonthlyConsumption, ConsumptionUnit, SubscriptionId FK)
- [x] Supports arbitrary number of rows per subscription (not hardcoded to the 3 example equipment types)
