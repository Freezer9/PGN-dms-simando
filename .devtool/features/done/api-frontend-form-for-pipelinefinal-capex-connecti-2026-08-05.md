...
## Acceptance Criteria
- [x] API endpoints to read/update `PipelineInfo` fields, scoped by workflow stage
- [x] Survey-stage form section: jarak/diameter/tekanan estimate
- [x] NOL/Capex-stage form section: pipa induk/service length+diameter, MRS spec
