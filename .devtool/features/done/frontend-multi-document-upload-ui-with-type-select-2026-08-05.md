...
## Acceptance Criteria
- [x] Document type selector added to the upload flow
- [x] List view groups/labels uploaded documents by type, not just by stage
- [x] Existing upload size/extension restrictions preserved
