...
## Acceptance Criteria
- [ ] Table view of subscriptions/prospects filterable by location + Jenis Produksi
- [ ] Clicking a row opens the entry form to complete Sales/Kawasan/Jalur assignment (feeds into epic-plotting)
