...
## Acceptance Criteria
- [ ] Clarify with stakeholders whether this duplicates or extends the Energy Needs equipment table from epic-energy
- [ ] `Kk0FuelUsage` child entity (or reuse) covering existing equipment/fuel breakdown
- [ ] `BebanPuncakMulai`/`BebanPuncakSelesai` fields (supports 2 shift windows per spec)
- [ ] `RencanaPemanfaatanGas` flags/entity (Bahan Baku/Bahan Bakar/Pembangkit Listrik/CNG/Transportasi Gas/Lainnya with free-text)
