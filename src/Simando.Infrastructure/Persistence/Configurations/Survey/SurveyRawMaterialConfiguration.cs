...
// Survey — Bahan Baku.
public sealed class SurveyRawMaterialConfiguration : IEntityTypeConfiguration<SurveyRawMaterial>
{
    public void Configure(EntityTypeBuilder<SurveyRawMaterial> builder)
    {
        builder.ToTable("survey_raw_material");
